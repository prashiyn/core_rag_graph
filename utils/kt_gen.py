...
class KTBuilder:
    ...
    def chunk_text(self, text) -> Tuple[List[str], Dict[str, str]]:
        ...
        # else:
        #     chunks = [str(text)]
        # ===== store full chunk payload as a single unit =====
        chunks = [text]
        chunk2id = {}
        for chunk in chunks:
            try:
    ...
    def _is_english(self, text: str) -> bool:
        """Return True if text is mostly Latin letters and common punctuation."""
        if not text:
            return False
    ...
    def process_all_documents(self, documents: List[Dict[str, Any]]) -> None:
        ...
        # self.process_level4()  # optional: level-4 community relations
    ...
    def build_knowledge_graph(self, file_name: str, documents: List[Dict]):
        ...
        # self.save_chunks_to_file()  # optional: persist chunks to disk
